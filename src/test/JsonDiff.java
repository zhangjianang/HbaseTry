...
////    System.out.println("we are the champion");
////    ReadWriteFile.readFileByLines(BatchSearchDetailInfoTest.class.getClassLoader().getResource("data/batchDetail.json").getPath());
//
//
//    SearchDetailInfo singleSearchDetail =new SearchDetailInfo();
//    String sget = com.alibaba.fastjson.JSONObject.toJSONString(singleSearchDetail.getDetailInfoByCompanyId("2"));
////    ReadWriteFile.writeFileByLines(JsonDiff.class.getClassLoader().getResource("data/singleDetail.json").getPath(),sget);
//
//    ReadWriteFile.anotherWriteFile(JsonDiff.class.getClassLoader().getResource("data/singleDetail.json").getPath(),sget);
////    System.out.println("插入成功!");
//
////    System.out.println(jsonEquals(fileJson,getSingle.toString()));
//
////    JSONObject json1 = JSONObject.fromObject("{\"a\":\"a\",\"b\":\"b\",\"c\":\"c\"}");
////    JSONObject json2 =  JSONObject.fromObject("{\"a\":\"a1sfsfsf\",\"b\":\"b\",\"c\":\"c\"}");
//
//    String fileJson= ReadWriteFile.readFileByLines(JsonDiff.class.getClassLoader().getResource("data/batchDetail.json").getPath());
//    String fileGetJson= ReadWriteFile.readFileByLines(JsonDiff.class.getClassLoader().getResource("data/singleDetail.json").getPath());
//    compareJson(fileJson, fileGetJson,null);
//
////    JSONObject json1 =  JSONObject.fromObject("{\"a\":\"a\",\"b\":\"b\",\"c\":\"c\"}");
////    JSONObject json2 =  JSONObject.fromObject("{\"a\":\"a1sfsfsf\",\"b\":\"b\",\"c\":\"c\"}");
