package com.company.pinBatchDetail;
...
public class PinBatchMain {

    public static PinBatchSearchDetailInfo pinSearchDetailInfo=new PinBatchSearchDetailInfo();
...
//            String inSql = createInSql(id,num);
            Map<String, Object> res = pinSearchDetailInfo.getDetailInfoByCompanyId(start,end);
       ...
       // args= new String[]{"90000000","100000000","1"};
        ...
        while(intStart<endStart){
          ...
          /*  fixedThreadPool.execute(new Runnable() {
            ...
            //// TODO: 2017/6/7 修改表
                    Map<String, Object> res = pinSearchDetailInfo.getDetailInfoByCompanyId(sa+"", se+"" );
