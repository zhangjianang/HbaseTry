 ...
 */
public class PinBatchCompanyDao {
    private BatchDBUtils dbUtils;
    public PinBatchCompanyDao(){
        this.dbUtils=new BatchDBUtils();
    }

    public Map<String,Map<String,Object>> getCompanyInfo(String insql){
        if(insql!=null&& StringUtil.isNotEmpty(insql)) {
            String sql = "select" +
            ...
            String newsql= "select * from company where company_org_type !='个体户'  and id in "+insql+" )";
            List<Map<String,Object>> res = null;
            res = dbUtils.query(newsql);
